class Charecter():
    ...
    def __str__(self):
        return (f'Имя: {self.name}\n '
                f'Раса:{self.race}\n '
                f'Класс: {self.clas}\n'
                f'ХП: {self.mhp}        Очки Защиты{self.cd}\n'
                'Навыки:              Характеристика:              Спасброски:\n'
                f'  атлетика: {self.skil[0]}                     сила: {self.mainscor[0]}                               сила: {self.selfthrow[0]}\n'
                f'акробатика: {self.skil[1]}                 ловкость: {self.mainscor[1]}                     ловкость: {self.selfthrow[1]}\n'
                f'ловкость рук: {self.skil[2]}              телосложение: {self.mainscor[2]}              телосложение: {self.selfthrow[2]}\n'
                f'скрытность: {self.skil[3]}                   интeллект: {self.mainscor[3]}               интeллект: {self.selfthrow[3]}\n'
                f'анализ: {self.skil[4]}                       мудрость: {self.mainscor[4]}                     мудрость: {self.selfthrow[4]}\n'
                f'история: {self.skil[5]}                     харизма: {self.mainscor[5]}                      харизма: {self.selfthrow[5]}\n'
                f'магия: {self.skil[6]}\n'
